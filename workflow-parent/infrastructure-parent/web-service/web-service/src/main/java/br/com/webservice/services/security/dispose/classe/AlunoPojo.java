...
class AlunoPojo {
    ...
    public String getQuilombola() {
        return quilombola;
    }

    public void setQuilombola(String quilombola) {
    ...
    public String getMobilidadeReduzida() {
        return mobilidadeReduzida;
    }

    public void setMobilidadeReduzida(String mobilidadeReduzida) {
