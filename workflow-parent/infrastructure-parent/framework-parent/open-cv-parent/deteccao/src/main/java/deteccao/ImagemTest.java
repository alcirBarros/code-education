...
public class ImagemTest {
    ...
    public static void main(String[] args) {
        ...
        Mat imagemColorida = imread("src/deteccao/opencv-java.jpg", Imgcodecs.IMWRITE_JPEG_QUALITY);
        Utilitarios utilitarios = new Utilitarios();

        utilitarios.mostraImagem(utilitarios.convertMatToImage(imagemColorida));

        Mat imagemCinza = new Mat();
        Imgproc.cvtColor(imagemColorida, imagemCinza, Imgproc.COLOR_RGB2GRAY);
