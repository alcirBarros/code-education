package br.com.context.model.tipogrupoanamnese.enumerator;

import br.com.context.model.Entidade;
import java.io.Serializable;

public enum TipoGrupoAnamneseEnum implements Entidade {
    ...
    private TipoGrupoAnamneseEnum(String descricao, Integer orderBy) {
