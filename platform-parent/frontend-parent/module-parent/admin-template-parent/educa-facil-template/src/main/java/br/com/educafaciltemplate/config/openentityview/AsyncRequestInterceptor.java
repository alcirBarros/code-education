...
/**
 * An interceptor with asynchronous web requests used in OpenSessionInViewFilter
 * and OpenSessionInViewInterceptor.
 *
 * Ensures the following: 1) The session is bound/unbound when "callable
 * processing" is started 2) The session is closed if an async request times out
