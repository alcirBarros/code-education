...
import br.com.context.util.Assert;
...
public class AdminUtils {
    ...
    /**
     * Copied from OmniFaces to avoid version conflicts (see
     * https://github.com/adminfaces/admin-template/issues/177)
     *
     * @param context
     * @param url
     * @param paramValues
    ...
    /**
     * Copied from OmniFaces to avoid version conflicts URL-encode the given
     * string using UTF-8.
     *
