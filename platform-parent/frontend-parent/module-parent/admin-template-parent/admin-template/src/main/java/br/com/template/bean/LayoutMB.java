...
import br.com.template.config.ControlSidebarConfig;
...
public class LayoutMB implements Serializable {
    ...
    private static final String APP_TEMPLATE_PATH = "/template/admin-template/template.xhtml"; // application template (left menu)
    private static final String APP_TEMPLATE_TOP_PATH = "/template/admin-template/template-top.xhtml"; //application template (top menu)
