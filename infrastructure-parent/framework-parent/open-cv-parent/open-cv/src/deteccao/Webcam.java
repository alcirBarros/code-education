...
public class Webcam extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        Webcam janele = new Webcam();
        janele.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        janele.setSize(600, 500);
        ...
        if (captura.isOpened()) {
            while (true) {
                ...
                if (captura.read(video)) {
                    ...
                    Imgproc.cvtColor(video, imagemCinza, COLOR_BGR2GRAY);

                    MatOfRect facesDetectadas = new MatOfRect();
                    classificador.detectMultiScale(imagemCinza, facesDetectadas, 1.2, 10, 3, new Size(50, 50), new Size(500, 500));

                    for (Rect rect : facesDetectadas.toArray()) {
                        System.out.println(rect.x + " " + rect.y + " " + rect.width + " " + rect.height);
                        Imgproc.rectangle(video, new Point(rect.x, rect.y), new Point(rect.x + rect.width, rect.y + rect.height), new Scalar(0, 0, 255), 4);
                    }
