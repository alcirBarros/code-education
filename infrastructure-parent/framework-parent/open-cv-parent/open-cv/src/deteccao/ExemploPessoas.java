...
public class ExemploPessoas {
    ...
    public static void main(String[] args) {
        ...
        cascadeClassifier.detectMultiScale(imagemCinza, facesDetectadas, 1.2, 2, 3, new Size(50, 50), new Size(95, 95));
...
//        CascadeClassifier classificadorOlhos = new CascadeClassifier("src/cascades/haarcascade_eye.xml");
//
//        classificadorOlhos.detectMultiScale(imagemCinza, olhosDetectados, 1.1, 1, 0, new Size(30, 30), new Size(50, 50));
//
